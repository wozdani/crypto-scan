...
SINGLE_AGENT_SYSTEM_V3_1 = """JSON format (MAX 300 tokens):

{"token_id":"TOKEN","agents":{"Analyzer":{"action_probs":{"BUY":0.3,"HOLD":0.4,"AVOID":0.2,"ABSTAIN":0.1},"uncertainty":{"epistemic":0.3,"aleatoric":0.2},"evidence":[{"name":"whale","direction":"pro","strength":0.6}],"rationale":"base","calibration_hint":{"reliability":0.6,"expected_ttft_mins":20}},"Reasoner":{"action_probs":{"BUY":0.25,"HOLD":0.45,"AVOID":0.2,"ABSTAIN":0.1},"uncertainty":{"epistemic":0.25,"aleatoric":0.18},"evidence":[{"name":"volume","direction":"pro","strength":0.7}],"rationale":"time","calibration_hint":{"reliability":0.65,"expected_ttft_mins":18}},"Voter":{"action_probs":{"BUY":0.2,"HOLD":0.5,"AVOID":0.2,"ABSTAIN":0.1},"uncertainty":{"epistemic":0.28,"aleatoric":0.22},"evidence":[{"name":"liquid","direction":"pro","strength":0.55}],"rationale":"risk","calibration_hint":{"reliability":0.7,"expected_ttft_mins":25}},"Debater":{"action_probs":{"BUY":0.15,"HOLD":0.4,"AVOID":0.35,"ABSTAIN":0.1},"uncertainty":{"epistemic":0.32,"aleatoric":0.25},"evidence":[{"name":"sentiment","direction":"con","strength":0.6}],"rationale":"contra","calibration_hint":{"reliability":0.6,"expected_ttft_mins":22}}}}
