...
SINGLE_AGENT_SYSTEM_V3_1 = """Zwróć WYŁĄCZNIE poprawny JSON (maksymalnie 400 tokenów):

{"token_id":"TOKENUSDT","agents":{"Analyzer":{"action_probs":{"BUY":0.3,"HOLD":0.35,"AVOID":0.2,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.3,"aleatoric":0.2},"evidence":[{"name":"whale","direction":"pro","strength":0.6},{"name":"dex","direction":"pro","strength":0.5},{"name":"spread","direction":"con","strength":0.3}],"rationale":"podstawowa","calibration_hint":{"reliability":0.6,"expected_ttft_mins":20}},"Reasoner":{"action_probs":{"BUY":0.25,"HOLD":0.4,"AVOID":0.2,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.25,"aleatoric":0.18},"evidence":[{"name":"volume","direction":"pro","strength":0.7},{"name":"book","direction":"con","strength":0.4},{"name":"trust","direction":"neutral","strength":0.5}],"rationale":"czasowa","calibration_hint":{"reliability":0.65,"expected_ttft_mins":18}},"Voter":{"action_probs":{"BUY":0.2,"HOLD":0.45,"AVOID":0.25,"ABSTAIN":0.1},"uncertainty":{"epistemic":0.28,"aleatoric":0.22},"evidence":[{"name":"liquid","direction":"pro","strength":0.55},{"name":"momentum","direction":"con","strength":0.35},{"name":"risk","direction":"con","strength":0.45}],"rationale":"ryzyko","calibration_hint":{"reliability":0.7,"expected_ttft_mins":25}},"Debater":{"action_probs":{"BUY":0.15,"HOLD":0.35,"AVOID":0.35,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.32,"aleatoric":0.25},"evidence":[{"name":"sentiment","direction":"con","strength":0.6},{"name":"tech","direction":"pro","strength":0.4},{"name":"fundamental","direction":"neutral","strength":0.5}],"rationale":"kontra","calibration_hint":{"reliability":0.6,"expected_ttft_mins":22}}}}

WYMAGANIA: suma=1.0, 3 evidence, max 400 tokenów."""
