...
SINGLE_AGENT_SYSTEM_V3_1 = """Zwróć WYŁĄCZNIE poprawny JSON dla tokena (bez żadnego tekstu przed/po):

{"token_id":"TOKENUSDT","agents":{"Analyzer":{"action_probs":{"BUY":0.30,"HOLD":0.35,"AVOID":0.20,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.3,"aleatoric":0.2},"evidence":[{"name":"whale_ping","direction":"pro","strength":0.6},{"name":"dex_inflow","direction":"pro","strength":0.5},{"name":"spread","direction":"con","strength":0.3}],"rationale":"analiza podstawowa","calibration_hint":{"reliability":0.6,"expected_ttft_mins":20}},"Reasoner":{"action_probs":{"BUY":0.25,"HOLD":0.40,"AVOID":0.20,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.25,"aleatoric":0.18},"evidence":[{"name":"volume_spike","direction":"pro","strength":0.7},{"name":"orderbook","direction":"con","strength":0.4},{"name":"trust_score","direction":"neutral","strength":0.5}],"rationale":"analiza czasowa","calibration_hint":{"reliability":0.65,"expected_ttft_mins":18}},"Voter":{"action_probs":{"BUY":0.20,"HOLD":0.45,"AVOID":0.25,"ABSTAIN":0.10},"uncertainty":{"epistemic":0.28,"aleatoric":0.22},"evidence":[{"name":"liquidity","direction":"pro","strength":0.55},{"name":"momentum","direction":"con","strength":0.35},{"name":"risk_level","direction":"con","strength":0.45}],"rationale":"ocena ryzyka","calibration_hint":{"reliability":0.7,"expected_ttft_mins":25}},"Debater":{"action_probs":{"BUY":0.15,"HOLD":0.35,"AVOID":0.35,"ABSTAIN":0.15},"uncertainty":{"epistemic":0.32,"aleatoric":0.25},"evidence":[{"name":"market_sentiment","direction":"con","strength":0.6},{"name":"technical_analysis","direction":"pro","strength":0.4},{"name":"fundamentals","direction":"neutral","strength":0.5}],"rationale":"kontra-argumenty","calibration_hint":{"reliability":0.6,"expected_ttft_mins":22}}}}

WYMAGANIA: action_probs suma=1.0, dokładnie 3 evidence per agent."""
